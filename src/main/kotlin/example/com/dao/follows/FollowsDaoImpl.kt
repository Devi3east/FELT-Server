...
class FollowsDaoImpl : FollowsDao {
    ...
    override suspend fun followsUser(follower: Long, following: Long): Boolean {
        return dbQuery {
    ...
    override suspend fun getFollowerIds(userId: Long, pageNumber: Int, pageSize: Int): List<Long> {
        return dbQuery {
            FollowsTable.select {
    ...
    override suspend fun getFollowingIds(userId: Long, pageNumber: Int, pageSize: Int): List<Long> {
        return dbQuery {
            FollowsTable.select {
